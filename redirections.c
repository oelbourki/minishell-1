...
/*   Updated: 2020/02/04 22:56:21 by oel-bour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	help_do_somein(t_command **head)
{
...
int	help_do_someout(t_command **head)
{
...
int do_someout(t_command **head)
{
	...
	g_counter->what == DOUBLEREDOUT))
	{
		...
		if (help_do_someout(&g_counter) == -1)
			return (-1);
		g_counter = g_counter->next->next;
	}
