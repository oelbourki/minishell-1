...
/*   Updated: 2020/01/26 10:51:57 by oel-bour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	dupx(int first, int last, int input, int fd[2])
{
	...
	if (red_in == 1)
	{
		output_fd = open(file_output, O_APPEND | O_CREAT | O_TRUNC, 0777);
		dup2(output_fd, 1);
		red_in = 0;
	}
	if (redin == 1)
...
char *path(char *f)
{
	char *s = "/Users/oel-bour/goinfre/homebrew/bin:/Users/oel-bour/.brew/opt/openssl@1.1/bin:/Users/oel-bour/.brew/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/local/munki:/Users/oel-bour/.brew/opt/openssl@1.1/bin:/Users/oel-bour/goinfre/anaconda3/bin:/Users/oel-bour/goinfre/anaconda3/condabin:/Users/oel-bour/.brew/bin";
